...
- Generally play nice with each other (both Markdown based).
- You get some stuff for free, e.g. citation management.
- Cross-referencing unfortunately not working ...
...
![Julia and Quarto: a perfect match. Image by author (heavily borrowing from `Javis.jl` [tutorial](https://juliaanimators.github.io/Javis.jl/stable/tutorials/tutorial_7/))](www/intro.gif){#fig-intro width="80%"}
